...
def main():
    ...
    for i in range(1,6):
        ...
        input_thompson_reward_1 = generate_normal_distribution_file(mean_list[:num_actions], v_list[:num_actions], total_steps,
                                                                         '../../data/test/sim_thompson_1_{0}.csv'
                                                .format(total_steps))
        ...
        models = [NIGNormal(mu=0, v=1, alpha=1, beta=1) for _ in range(num_actions)]
        calculate_thompson_single_bandit('../../data/test/sim_thompson_1_{0}.csv'.format(total_steps), 
                                         num_actions=num_actions, 
                                         dest='../../data/test/sim_thompson_one_bandit_{0}.csv'.format(total_steps), 
                                         models=models, 
